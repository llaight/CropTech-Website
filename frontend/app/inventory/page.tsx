...
export default function InventoryPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-white to-slate-100 min-h-full">
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-slate-600">Manage and track your rice inventory across all field locations.</p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                {inventoryData.map((item) => (
                  <div
                    key={item.id}
                    className="group cursor-pointer p-4 rounded-xl border border-slate-200 hover:border-green-300 hover:bg-green-50/50 transition-all duration-200 hover:shadow-md"
